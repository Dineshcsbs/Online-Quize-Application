...
//    public static String userCredential=jwtFilter.extractUsername().get("sub", String.class);
...
//                                  findAllByIsActiveTrueAndIsRemovedFalseAndUser_Id
